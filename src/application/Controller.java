...
public class Controller implements Initializable{
	...
	public static ArrayList<Nodee> al = new ArrayList<>();
	Stage secondStage;
	@Override
	...
	public void fileCitiesWithCor(ActionEvent e) {
		...
		while(in.hasNextLine()) {
			...
			Nodee v = new Nodee(arrstr[0],Integer.parseInt(arrstr[1]),Integer.parseInt(arrstr[2]));
			al.add(v);
		}
	...
	public void fileCitiesWithAdj(ActionEvent e) {
		...
		while(in.hasNextLine()) {
			String str = in.nextLine();
			String[] arrstr = str.split(" ");
			ArrayList<Nodee> al2 = new ArrayList<>();
	...
	public void PressWhenDone(ActionEvent e) throws IOException {
		Parent root = FXMLLoader.load(getClass().getResource("/application/Map.fxml"));
